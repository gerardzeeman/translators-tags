#!/usr/bin/env python3
"""Load parse_ngb_nl.py's JSONL into the `translation` table, matching each
row to its Latin segment by ref (work slug 'ngb').

    python scripts/load_ngb_nl.py ngb_nl.jsonl
